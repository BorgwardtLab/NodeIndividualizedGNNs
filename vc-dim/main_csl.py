...
def main():
    ...
    for n in [17, 41, 83]: 
        ...
        for ntrain in [1,10,100,1000]: 
            ...
            args.logger = SummaryWriter(log_dir=f'runs/csl_own/indiv{args.ind_type}/acc_layers{args.layers}_dim{args.ind_dim}_hidden{args.hidden}_lr{args.lr}_size{n}_train{ntrain}_test{ntest}')
